...
This script:
1. Adds the project directory to PYTHONPATH so docgen can be found
2. Runs the docgen CLI for each Python file
3. Returns appropriate exit code (0 = pass, 1 = fail)
"""
import sys
import os
import subprocess
